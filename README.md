# Сделать
- Проверку на длину пароля
- Уведомление о создании семьи заранее
- Нормальное разделение личных от семейных
- "Продолжить без аккаунта" сделать по ярче
- Темную тему
- Локальное хранилище
- Починить автозагрузку тасков
- Починить экран семьи
- Убрать вкладку все (сегодня), сжать кнопки и добавить поиск
- Починить имя пользователя
- Добавить FAB в таски и исправить интерфейс 
- Изменить экран создания такси на редактирование таски
